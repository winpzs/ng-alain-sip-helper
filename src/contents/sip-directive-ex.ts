...
export class SipDirectiveEx implements ContentBase {
    ...
    contentTS(params: GenerateParam): string {
        ...
        let content = `import { Directive, ViewContainerRef } from '@angular/core';
import { SipDirective, SipNgInit } from 'sip-alain';
        
@Directive({
    selector: '[sip${name}]'
})
export class ${name}Directive extends SipDirective {
